...
public class MangaController {
    ...
    @PostMapping("")
    public ResponseEntity<?> saveManga(@Valid @RequestBody MangaRequest request, Principal principal)throws MessagingException   {
    ...
    public ResponseEntity<Void> deleteManga(@PathVariable Integer mangaId) {
        try {
            ...
            return ResponseEntity.notFound().build(); // Trả về mã trạng thái HTTP 404 Not Found nếu không tìm thấy Manga
        }
    }
